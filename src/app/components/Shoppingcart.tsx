...
const Shoppingcart = () => {
  return (
    <div className="sm:w-[1440px] w-[390px]  sm:pt-[64px] sm:px-[188px] px-[23px] pt-[36px] ">
        ...
        <div className=" sm:flex font-clash font-normal text-[14px] leading-[19.6px] sm:mt-[48px] mt-[40px] hidden">
            <p className=" sm:mr-[595px]">Product</p>
            <p className=" sm:mr-[317px]">Quantity</p>
            <p>Total</p>
        </div>
