  ...
  return (
    <div id="filters" className="w-[1440px] flex py-[20px] sm:py-[8px] pl-[24px] justify-between">
        <div className=" flex sm:hidden gap-[16px] mt">
            ...
            <button className=" w-[163px] h-auto flex gap-[8px] items-center justify-center py-[16px] pl-[24px] pr-[32px] bg-[#F9F9F9]">
                <p className="font-clash font-normal text-[16px] leading-[24px] ">Sorting</p>
                <Image src={aero} alt=""/>
            </button>
        </div>

        <div id="filters2" className="w-auto h-[48px] gap-[12px] hidden items-center justify sm:flex ">
        ...
        <div id="sorting" className=" hidden sm:flex justify-center items-center gap-[16px] mr-[84px]">
