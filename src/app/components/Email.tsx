 ...
 const Email = () => {
   return (
    <div className="">
        <div className="bg-[url('/img.jpg')] sm:w-[1440px] sm:h-[444px] w-[390px] h-[370px] bg-cover sm:bg-center bg-left-bottom sm:pt-[97px] pt-[24px] pl-[24px] pr-[37px] sm:px-[0px] ">
            <div id="top content" className=" w-auto h-auto sm:mx-[473px] flex flex-col sm:gap-[30px] gap-[20px] ">
            ...
            <div className="w-auto h-auto sm:mx-[484px] mt-[40px] flex ">
                <input type="text" placeholder="      your@email.com" className=" w-[354px] h-[56px]"/>
