...
const CartItems = (prop : ipropcartitem) => {
  ...
  return (
    <div>
        <div id="product card" className="w-auto sm:flex sm:flex-row flex-col ">
            <div id="product one " className=" w-auto h-auto flex sm:gap-[21px] gap-[22px]">
               <Image src={image} alt="" className="w-[109px] h-[134px] bg-cover bg-center"/>
                <div id=" description" className=" flex flex-col gap-[8px]">
                    ...
                    <p className="font-satoshi font-normal sm:text-[14px] sm:leading-[21px]  text-[14px] leading-[21px]   ">{description}</p>
            ...
            <div className="w-[122px] justify-between px-[16px] py-[12px] sm:ml-[341px]  sm:mr-[252px] font-satoshi font-normal text-[16px] leading-[21.6px] sm:flex hidden"> 
            <p className="text-[#EBE8F4]">-</p>
            <p className=" ">1</p>
            <p className="text-[#EBE8F4]">+</p>  
            </div>
