...
const Email2 = () => {
  return (
    <div className="sm:w-[1440px] sm:h-[481px] w-[390px] h-[370px]   sm:pb-[65px] sm:pt-[52px] sm:pl-[93px] sm:pr-[74px] text-[#2A254B] bg-[#F9F9F9] p-0 ">
         <div className=" sm:w-auto sm:h-h-auto  sm:px-[351px] sm:pt-[68px] sm:pb-[54px]   pl-[24px] pr-[37px] pt-[46px] pb-[54px] bg-white ">
